...
class ResumenIngresosRecyclerViewAdapter() : RecyclerView.Adapter<ResumenIngresosRecyclerViewAdapter.ViewHolder>() {
    lateinit var context: Context
    lateinit var cursor: Cursor

    fun ResumenIngresosRecyclerViewAdapter(context: Context,cursor: Cursor){
